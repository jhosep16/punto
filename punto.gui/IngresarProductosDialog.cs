...
namespace punto.gui
{
	public partial class IngresarProductosDialog : Gtk.Dialog
	{
		...
		protected void OnBotonAgregarPClicked (object sender, EventArgs e){
			agregarproducto bod = new agregarproducto(Int32.Parse(entry12.Text.Trim()),entry16.Text.Trim(),Int32.Parse(entry13.Text.Trim()),combobox4.ActiveText, checkbox,checkbox2);
